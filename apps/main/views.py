...
from ..api.models import Estacion, Sensor_Estacion, Componente_Estacion, Salidas_De_Campo, Calendario_Salidas_De_Campo
...
def index(request):
    ...
    return render(request, "main/index.html", {'estaciones_list': estacion, 'componentes_estacion_list': componente, 'sensores_estacion_list': sensor, 'salida_de_campo_list': salida, 'calendario_list': calendario})
